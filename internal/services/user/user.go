...
func (s *InternalWsUserService) SendUpdateUserEvent(req *proto.AuthenticateRequest, userId string) error {

	params := url.Values{}
	params.Set("user_id", userId)

	request, err := http.NewRequest("POST", "http://unix/user/@updated", strings.NewReader(params.Encode()))
	if err != nil {
		return err
	}
